...
describe('Página de cadastro', () => {
  ...
  context('Verifica redirecionamento de página', () => {
    it('Clica no link "Cadastra-se" e redireciona a página de cadatro da clínica', () => {
      cy.get('[href="/cadastro"]').click();
      cy.location('pathname').should('equal', '/cadastro');
    });
  });

  context('Primeira parte da sessão do cadastro', () => {
  ...
  context('Sessão de cadastro completa', () => {
    ...
    it('Cadastra uma clínica', () => {
      ...
      cy.get('[data-test="inputCNPJ"]').type(faker.string.numeric(6));
